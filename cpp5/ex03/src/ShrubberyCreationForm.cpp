...
/*   Updated: 2025/03/28 15:38:33 by prambaud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm* ShrubberyCreationForm::creat(std::string target)
{
    ShrubberyCreationForm *TheForm = new ShrubberyCreationForm(target);
